...
const nextOrFinish = async () => {
    ...
    if (currentTextIndex === texts.length - 1) {
        // Handle finishing logic here
        console.log('Finish');
        navigation.navigate('SomeOtherScreen'); // or any other finishing logic
    } else {
        // Move to next text
...
const uploadRecording = async (uri) => {
  ...
  return (
    ...
    <View style={styles.action}>
      ...
      >
      <TouchableOpacity onPress={recordAgain} style={styles.actionButton}>
      ...
      <ImageBackground
        ...
        style={styles.imageBackground}
      >
      <TouchableOpacity onPress={nextOrFinish} style={styles.actionButton}>
