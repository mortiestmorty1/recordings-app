...
import LinearGradient from 'react-native-linear-gradient'; // Ensure this import is correct

const FirstScreen = () => {
  return (
    <LinearGradient
      // Define the gradient colors here
      colors={['#818589', '#FFFFFF']}
      // Apply the container styles to LinearGradient instead
...
const styles = StyleSheet.create({
  ...
  btnText: {
    color: '#818589', // Style for the text inside TouchableOpacity
  },
});
