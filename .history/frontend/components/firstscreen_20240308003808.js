...
const FirstScreen = () => {
  return (
    <View style={styles.container}>
        <ImageBackground
        source={{uri: 'https://images.unsplash.com/photo-1612838320303-3e3e3e3e3e3e?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60'}}
        resizeMode="cover"
...
const styles = StyleSheet.create({
  ...
  logo: {
    width: 200,
    height: 200,
    bottom: 100, // Changed from bottom to marginBottom for better layout control
  },
  text: {
    fontSize: 20,
    margin: 20,
  ...
  btnText: {
    color: '#A9A9A9', // Style for the text inside TouchableOpacity
  },
});
