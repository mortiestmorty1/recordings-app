...
const stopRecordingAndUpload = async () => {
    ...
    try {
      ...
      let durationInSeconds = (endRecordingTime - startRecordingTime) / 1000;
      if (durationInSeconds < 3) {
        // Inform the user that the recording was too short
        alert("Recording is too short. Please record for at least 3 seconds.");
        // Optionally, call startRecording() again to prompt a re-recording
        return;
    }
      if (uri) {
