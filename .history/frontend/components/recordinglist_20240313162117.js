...
const styles = StyleSheet.create({
  ...
  listContainer: {
    ...
    marginTop: 100, // Optional: adjust as needed to ensure list starts below any top UI elements
  },
  buttonContainer: {
    alignItems: 'center',
    marginBottom: 20,
    marginTop:20, // Space from bottom
  },
  recordingItem: {
    padding: 10,
    fontSize: 18,
    ...
    marginVertical: 5,
    backgroundColor:"grey", // Spacing between items
  },
  btn1: {
    width: 250,
    height: 50,
