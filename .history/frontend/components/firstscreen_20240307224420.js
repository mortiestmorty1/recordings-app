...
const FirstScreen = () => {
    return (
        ...
        <View style={styles.content}>
            <Button style={styles.btn1} title="Get Started"/>
            <Text style={styles.text}>Already registered?</Text>
            <Button style={styles.btn2} title="Revisit"/>
        </View>
        </View>
    );
}
...
const styles = StyleSheet.create({
    ...
    btn1: {
        ...
        color: 'grey', // Sets the text color to grey (Note: This is for the text inside the button)
        borderRadius: 10, // Sets rounded borders with a radius of 10
