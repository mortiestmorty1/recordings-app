  ...
  return (
    <View style={styles.container}>
      <Svg style={styles.logo} fill="#000000" width="150" height="150" viewBox="0 0 1024 1024">
        ...
        <Text style={styles.mustread}>you need to provide us the given below information and your consent is needed to record your voices with out you cannot continue.</Text>
      <Text >Name:</Text>
      <TextInput
        style={styles.input}
