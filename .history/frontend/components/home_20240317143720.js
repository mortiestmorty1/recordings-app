...
const Home = ({ navigation, route }) => {
  ...
  const startRecording = async () => {
    ...
    try {
        ...
        // Wait for the start sound to finish plus a little extra time before starting the recording
        // Assuming the start sound is very short, wait for 1 second (1000 milliseconds) or adjust this value as needed
        setTimeout(async () => {
            startSpinning();
