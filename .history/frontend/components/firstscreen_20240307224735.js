...
const styles = StyleSheet.create({
  ...
  logo: {
    width: 200,
    height: 200,
    marginBottom: 100, // Changed from bottom to marginBottom for better layout control
  },
  text: {
    fontSize: 20,
    margin: 20,
  ...
  content: {
    justifyContent: 'center',
    alignItems: 'center',
    marginTop: 250, // Changed from top to marginTop for better layout control
  },
  btn1: {
    width: 100,
    height: 50,
  ...
  btnText: {
    color: 'white', // Style for the text inside TouchableOpacity
  },
});
