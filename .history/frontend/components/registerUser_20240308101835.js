    ...
    <View style={styles.container}>
      <Svg style={styles.logo} fill="#000000" width="150" height="150" viewBox="0 0 1024 1024">
        ...
        <View style={styles.mustReadContainer}>
           <Text style={styles.mustread}>You need to provide us the below information and your consent is needed to record your voices with out you cannot continue.</Text>
        </View>
      <Text >Name:</Text>
      <TextInput
        style={styles.input}
      ...
      <TouchableOpacity style={styles.registerbtn}>
            <Text style={styles.regtext}onPress={handleRegistration}>Register</Text>
          </TouchableOpacity>
    </View>
  );
};
...
const styles = StyleSheet.create({
  ...
  mustReadContainer: {
    alignItems: 'flex-start', // Aligns text container to the start
    justifyContent: 'center', // Centers container
    marginHorizontal: 20, // Provides horizontal spacing
    marginBottom: 20, // Spacing from the bottom of the container to the next element
  },
  mustread: {
    fontSize: 15,
    color: '#808080',
    textAlign: 'left', // Aligns text to the left within its container
    // Removed justifyContent and alignItems since they don't apply to Text component
  },
  container: {
    flex: 1,
