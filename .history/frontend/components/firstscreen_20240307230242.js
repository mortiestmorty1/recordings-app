...
const FirstScreen = () => {
  return (
    <LinearGradient
      ...
      colors={['#6082B6', '#A9A9A9']}
      // Style using your existing container styles but without backgroundColor
...
const styles = StyleSheet.create({
  ...
  logo: {
    marginBottom: 100, // Adjust the position of the logo as needed
  },
  text: {
    fontSize: 20,
    margin: 20,
  ...
  content: {
    position: 'absolute', // Use absolute positioning to align content
    top: '60%', // Adjust based on content size
    alignItems: 'center',
  },
  btn1: {
    width: 200,
