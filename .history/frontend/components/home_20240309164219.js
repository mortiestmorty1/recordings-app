...
import {Image, View, Text, Button, StyleSheet, Alert, Platform ,TouchableHighlight, Animated, Easing} from 'react-native';
<View style={{ width: size, height: size }}>
  <Svg width={size} height={size} viewBox="0 0 122.88 122.88" {...lineProps}>
    <Path d="..." />
  </Svg>
</View>
</TouchableHighlight>, Animated, Easing} from 'react-native';
