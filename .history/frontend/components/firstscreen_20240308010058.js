...
const FirstScreen = () => {
  ...
  const loadFonts = async () => {
    await Font.loadAsync({
      'Roboto-Regular': require('../assets/fonts/Roboto-Regular.ttf'), // Adjust the path as necessary
    });
    setFontsLoaded(true);
  };
  ...
  // Show nothing or a loading spinner until fonts are loaded
  if (!fontsLoaded) {
...
const styles = StyleSheet.create({
  ...
  content: {
    justifyContent: 'center',
    alignItems: 'center',
    marginTop: 250, // Adjust based on your layout needs
  },
  btn1: {
    width: 200,
    height: 50,
  ...
  btnText: {
    color: 'black',
    fontFamily: 'Roboto-Regular', // This applies the Roboto font
  },
});
